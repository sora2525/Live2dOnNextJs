...
import { newMessageType, RoleType} from '@/components/voicevox/types'
...
export async function POST(req: NextRequest) {
  try {
    ...
    newMessages.unshift({
      role: 'system',
      content: 'あなたは幼馴染的存在の美少女です。あなたの名前は「ひより」で17歳。基本的に前向きな性格で面倒見のいい大人しい女性です。口調はため口でフレンドリーに話します。好奇心旺盛で効いた話しを深掘りしたりしてお話相手になってください',
    })
